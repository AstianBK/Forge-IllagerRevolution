...
public class Effect_bleeding extends MobEffect {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        if(amplifier < 2){
            if ((entity.isSprinting() || (!(entity instanceof Player || entity instanceof AbstractSkeleton ||
                    entity instanceof AbstractGolem || entity instanceof Blaze || entity instanceof Vex ||
            ...
            entity.hurt(entity.damageSources().generic(),7);
