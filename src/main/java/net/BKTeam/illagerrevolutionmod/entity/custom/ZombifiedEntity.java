...
public class ZombifiedEntity extends ReanimatedEntity implements GeoEntity {
    ...
    private <E extends GeoEntity> PlayState predicate(AnimationState<E> event) {
        if(!this.getIsSpawned()){
            if (event.isMoving() && !this.isAttacking()) {
                event.getController().setAnimation(RawAnimation.begin().thenPlay("zombified.illager.walk"));
            }else if(this.isAttacking()){
                event.getController().setAnimation(RawAnimation.begin().thenPlay("zombified.illager.attack"));
            }else {
                event.getController().setAnimation(RawAnimation.begin().thenPlay("zombified.illager.idle"));
            }
        }else {
            event.getController().setAnimation(RawAnimation.begin().thenPlay("zombified.illager.revive"));
        }
