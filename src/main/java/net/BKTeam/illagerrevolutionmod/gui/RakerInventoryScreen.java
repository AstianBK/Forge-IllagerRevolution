...
public class RakerInventoryScreen extends AbstractContainerScreen<RakerInventoryMenu>{
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pX, int pY) {
        ...
        if (this.raker.isTame()) {
            blit(pPoseStack, i + 7, j + 35, 0, this.imageHeight + 54, 18, 18);
            blit(pPoseStack, i + 7, j + 53, 18, this.imageHeight + 54, 18, 18);
        }
        InventoryScreen.renderEntityInInventoryFollowsMouse(pPoseStack,i + 51, j + 60, 17, (float)(i + 51) - this.xMouse, (float)(j + 75 - 50) - this.yMouse, this.raker);
    }
