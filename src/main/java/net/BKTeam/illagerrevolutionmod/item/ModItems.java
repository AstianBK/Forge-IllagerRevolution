...
public class ModItems {
    ...
    public static final RegistryObject<Item> ARROW_BEAST = ITEMS.register("arrow_beast",
            ()->new ArrowBeastItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> EVOKER_ROBE_ARMOR = ITEMS.register("evoker_robe_armor",
            ()-> new ArmorEvokerRobeItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties()));

    public static final RegistryObject<Item> ILLUSIONER_ROBE_ARMOR = ITEMS.register("illusioner_robe_armor",
            ()-> new ArmorIllusionerRobeItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties()));

    public static final RegistryObject<Item> PILLAGER_VEST_ARMOR = ITEMS.register("pillager_vest_armor",
            ()-> new ArmorPillagerVestItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties()));

    public static final RegistryObject<Item> PILLAGER_LEGGINS_ARMOR = ITEMS.register("pillager_leggins_armor",
            ()-> new ArmorPillagerVestItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.LEGGINGS,
                    new Item.Properties()));
    
    public static final RegistryObject<Item> PILLAGER_BOOTS_ARMOR = ITEMS.register("pillager_boots_armor",
            ()-> new ArmorPillagerVestItem(ModArmorMaterials.ILLAGERARMOR,  ArmorItem.Type.BOOTS,
                    new Item.Properties()));

    public static final RegistryObject<Item> VINDICATOR_JACKET_ARMOR = ITEMS.register("vindicator_jacket_armor",
            ()-> new ArmorVindicatorJacketItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties()));

    public static final RegistryObject<Item> VINDICATOR_LEGGINS_ARMOR = ITEMS.register("vindicator_leggins_armor",
            ()-> new ArmorVindicatorJacketItem(ModArmorMaterials.ILLAGERARMOR, ArmorItem.Type.LEGGINGS,
                    new Item.Properties()));
    
    public static final RegistryObject<Item> HELMET_MINER_REINFORCED = ITEMS.register("helmet_miner_reinforced",
            ()-> new IllagiumArmorItem(ModArmorMaterials.ILLAGIUM, ArmorItem.Type.HELMET,
                    new Item.Properties()));

    public static final RegistryObject<Item> HELMET_MINER = ITEMS.register("helmet_miner",()->
            new IllagiumArmorItem(ModArmorMaterials.BASICILLAGIUM,ArmorItem.Type.HELMET,
                    new Item.Properties()));

    public static final RegistryObject<Item> GOGGLES_MINER = ITEMS.register("goggles_miner",()->
            new ArmorGogglesItem(ModArmorMaterials.BASICILLAGIUM,ArmorItem.Type.HELMET,
                    new Item.Properties()));

    public static final RegistryObject<Item> GOGGLES_MINER_REINFORCED = ITEMS.register("goggles_miner_reinforced",()->
            new ArmorGogglesItem(ModArmorMaterials.ILLAGIUM,ArmorItem.Type.HELMET,
                    new Item.Properties()));

    public static final RegistryObject<Item> SCRAPPER_ARMOR_ILLAGIUM = ITEMS.register("scrapper_armor_illagium",()->
            new RakerArmorItem(new Item.Properties().durability(1550),20,"illagium",ModArmorMaterials.ILLAGIUM,0.0d,0,EquipmentSlot.CHEST));

    public static final RegistryObject<Item> SCRAPPER_ARMOR_NETHERITE = ITEMS.register("scrapper_armor_netherite",()->
            new RakerArmorItem(new Item.Properties().durability(1000),30,"netherite",ArmorMaterials.NETHERITE,0.0d,0,EquipmentSlot.CHEST));

    public static final RegistryObject<Item> SCRAPPER_ARMOR_DIAMOND = ITEMS.register("scrapper_armor_diamond",()->
            new RakerArmorItem(new Item.Properties().durability(700),25,"diamond",ArmorMaterials.DIAMOND,0.0d,0,EquipmentSlot.CHEST));

    public static final RegistryObject<Item> SCRAPPER_ARMOR_GOLD = ITEMS.register("scrapper_armor_gold",()->
            new RakerArmorItem(new Item.Properties().durability(350),5,"gold",ArmorMaterials.GOLD,0.0d,0,EquipmentSlot.CHEST));

    public static final RegistryObject<Item> SCRAPPER_ARMOR_IRON = ITEMS.register("scrapper_armor_iron",()->
            new RakerArmorItem(new Item.Properties().durability(500),10,"iron",ArmorMaterials.IRON,0.0d,0,EquipmentSlot.CHEST));



    public static final RegistryObject<Item> CLAWS_ARMOR_ILLAGIUM = ITEMS.register("claws_armor_illagium",()->
            new RakerArmorItem(new Item.Properties().durability(1000),0,"illagium",ModArmorMaterials.ILLAGIUM,0.5d,60,EquipmentSlot.LEGS));

    public static final RegistryObject<Item> CLAWS_ARMOR_NETHERITE = ITEMS.register("claws_armor_netherite",()->
            new RakerArmorItem(new Item.Properties().durability(500),0,"netherite",ArmorMaterials.NETHERITE,0.8d,70,EquipmentSlot.LEGS));

    public static final RegistryObject<Item> CLAWS_ARMOR_DIAMOND = ITEMS.register("claws_armor_diamond",()->
            new RakerArmorItem(new Item.Properties().durability(300),0,"diamond",ArmorMaterials.DIAMOND,0.6d,60,EquipmentSlot.LEGS));

    public static final RegistryObject<Item> CLAWS_ARMOR_GOLD = ITEMS.register("claws_armor_gold",()->
            new RakerArmorItem(new Item.Properties().durability(100),0,"gold",ArmorMaterials.GOLD,0.2d,40,EquipmentSlot.LEGS));

    public static final RegistryObject<Item> CLAWS_ARMOR_IRON = ITEMS.register("claws_armor_iron",()->
            new RakerArmorItem(new Item.Properties().durability(200),0,"iron",ArmorMaterials.IRON,0.3d,50,EquipmentSlot.LEGS));
